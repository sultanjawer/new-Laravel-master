                ...
                <div class="panel-content" id="sklGenerate" style="display:none; background-color:#fbffff">
                    <div class="row">
                        ...
                        <div class="col-md-4 d-flex p-1 mt-1">
                            <div class="form-group mr-1">
                                ...
                                <div id="qrcode" class="input-group" data-toggle="tooltip" data-offset="0" data-original-title="Generate QR Code">
                                    <button class="btn btn-sm btn-info btn waves-effect waves-themed" role="button"><i class="fal fa-qrcode mr-1"></i>Generate QR Code</button>
                                </div>
                            </div>
                            <div class="form-group">
                                <!--
                                ...
                                <div id="print_draft" class="input-group" data-toggle="tooltip" data-offset="0" data-original-title="Cetak Draft untuk ditandatangani">
                                    <a href="{{route('admin.skl.form')}}" class="btn btn-sm btn-warning btn waves-effect waves-themed" role="button"><i class="fal fa-print mr-1"></i>Cetak Draft</a>
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <span class="help-block">Unggah berkas SKL yang telah Anda cetak sebelumnya dan ditandatangani oleh Pejabat terkait.</span>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <div class="input-group-append">
                                    <a class="btn btn-sm btn-danger" href="{{route('admin.skl.index')}}" role="button"><i class="fal fa-times text-align-center mr-1"></i> Batalkan</a>
                                </div>
                                <!--
								...
								-->
                                <div class="input-group-append">
                                    <a href="{{route('admin.skl.success')}}" class="btn btn-sm btn-primary" role="button" type="submit">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <div class="input-group-append">
                                    <a href="{{route('admin.skl.postponed')}}" class="btn btn-sm btn-primary" role="button" type="submit">
                                        <i class="fas fa-file-certificate text-align-center mr-1"></i> Submit
                                    </a>
                                </div>
                            </div>
                            <span class="help-block">Pastikan Anda menekan tombol bukan karena ketidak-sengajaan.</span>
