    ...
    <div class="col-lg-12">
        ...
        <div id="panel-5" class="panel">
            ...
            <div class="panel-hdr">
                ...
                <div class="panel-toolbar">
                    <a href="/verification/online/add_check" class="mr-1 btn btn-primary btn-xs btn-icon rounded-circle waves-effect waves-themed" data-toggle="tooltip" data-offset="0,10" data-original-title="Tambah Pemeriksaan Kelompoktani">
                        ...
                        <table id="dt-geoCheck" class="table table-sm table-bordered table-hover table-striped w-100">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="/verification/online/show_check"><i class="fal fa-edit"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td hidden>Kelompoktan</td>
