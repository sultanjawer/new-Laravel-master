                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="justify-content-center">
                                        ...
                                        <a class="text-info mr-1" href="{{route('user.pks.create')}}" role="button" data-toggle="tooltip" data-original-title="buat Rencana Tanam/PKS" data-offset="0,10"><i class="fal fa-plus-circle"></i></a>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="justify-content-center">
                                        ...
                                        <a class="text-warning mr-1" href="{{route('user.pks.show')}}" role="button" data-toggle="tooltip" data-original-title="ubah Rencana Tanam/PKS" data-offset="0,10"><i class="fal fa-edit"></i></a>
                                        <a class="text-primary mr-1" href="{{route('user.pks.members')}}" role="button" data-toggle="tooltip" data-original-title="Member Management" data-offset="0,10"><i class="fal fa-users"></i></a>
                                        <a class="text-primary mr-1" href="{{route('user.pks.saprodi')}}" role="button" data-toggle="tooltip" data-original-title="Bantuan Saprodi" data-offset="0,10"><i class="fal fa-hands-helping"></i></a>
                ...
                <div class="panel-content justify-content-center text-center">
                    <div class="row d-flex">
                        <div class="col-md-6 my-1">
                            <a href="{{route('user.submission.vcheck')}}" class="btn btn-sm btn-warning btn-block" data-toggle="tooltip" data-offset="0,10" data-original-title="Ajukan Verifikasi"><i class="fas fa-badge-check"></i> Ajukan Verifikasi</a>
                        </div>
                        <div class="col-md-6 my-1">
                            <a href="{{route('user.submission.sklcheck')}}" class="btn btn-sm btn-success btn-block" data-toggle="tooltip" data-offset="0,10" data-original-title="Ajukan Keterangan Lunas"><i class="fas fa-award"></i> Ajukan SKL</a>
                        </div>
                    </div>
                </div>
            </div>
