                    ...
                    <table id="daftaranggota" class="table table-sm table-bordered table-hover table-striped w-100">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Luas</td>
                                <td>
                                    <a href="  " data-toggle="tooltip" title data-original-title="Lihat/Ubah data" class="badge btn-xs btn-primary waves-effect waves-themed"><i class="fal fa-edit"></i></a>
                                    <a href="" data-toggle="tooltip" title data-original-title="Hapus data" class="badge btn-xs btn-danger waves-effect waves-themed"><i class="fal fa-trash"></i></a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
