                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="justify-content-center">
                                        <a class="mr-1" href="{{route('user.farm.index')}}" role="button" data-toggle="tooltip" data-original-title="Farm Management" data-offset="0,10"><i class="fas fa-map-marked-alt text-warning"></i></a>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="justify-content-between">
                                        <a class="mr-1" href="{{route('user.farm.index')}}" role="button" data-toggle="tooltip" data-original-title="Farm Management" data-offset="0,10">
