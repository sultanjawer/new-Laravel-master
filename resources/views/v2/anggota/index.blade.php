    ...
    <div class="col-md-8">
        <div class="panel" id="panel-3">
            <div class="panel-hdr">
                ...
                <div class="panel-toolbar">
                    <a class="btn btn-xs btn-primary mr-1 ml-1" href="{{route('v2.keltan.anggota.create')}}"><i class="fal fa-plus mr-1"></i>Add Anggota</a>
                    ...
                    <table id="daftaranggota" class="table table-sm table-bordered table-hover table-striped w-100">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Luas</td>
                                <td>
                                    <a href="{{route('v2.keltan.anggota.show')}}" data-toggle="tooltip" title data-original-title="Lihat/Ubah data" class="badge btn-xs btn-primary waves-effect waves-themed"><i class="fal fa-edit"></i></a>
