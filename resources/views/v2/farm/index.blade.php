    ...
    <div class="col-md-9">
        <div class="panel" id="panel-2">
            <div class="panel-hdr">
                ...
                <div class="panel-toolbar">
                    <a href="{{route('v2.farm.create')}}" role="button" class="btn btn-xs btn-info mr-1" data-toggle="tooltip" data-offset="0,1" title data-original-title="Tambah lokasi tanam (input)"><i class="fal fa-draw-polygon"></i> </a>
