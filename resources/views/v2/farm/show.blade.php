...
<div class="row">
    <div class="col-12">
        <form id="js-login" novalidate="" action="{{route('v2.farm.index')}}">
                ...
                <div class="panel-container show">
                    ...
                    <div class="card-footer">
                        <div class="justify-content-end">
                            <a href="{{route('v2.farm.index')}}" class="btn btn-sm btn-info" role="button"><i class="fa fa-door-open mr-1"></i>Kembali</a>
                            <button class="btn btn-sm btn-primary" role="button" type="submit"><i class="fa fa-save mr-1"></i>Simpan</button>
                            <a href="{{route('v2.farm.index')}}" class="btn btn-sm btn-warning"><i class="fa fa-undo mr-1"></i>Batal</a>
                        </div>
                    </div>
                </div>
            </div>
