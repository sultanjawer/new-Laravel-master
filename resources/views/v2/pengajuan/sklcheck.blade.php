            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <div class="input-group-append">
                        <a class="btn btn-sm btn-danger" href="{{route('v2.submission.index')}}" role="button"><i class="fal fa-times text-align-center mr-1"></i> Batalkan</a>
                    </div>
                    <!--
					...
					-->
                    <div class="input-group-append">
                        <a href="{{route('v2.submission.sklsuccess')}}" class="btn btn-sm btn-primary" role="button" type="submit">
