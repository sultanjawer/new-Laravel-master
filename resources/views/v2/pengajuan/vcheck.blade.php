                            ...
                            <div class="form-group col-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <a class="btn btn-danger" href="{{route('v2.submission.index')}}" role="button"><i class="fal fa-times text-align-center mr-1"></i> Batalkan</a>
                                    </div>
                                    <!--
								    ...
								    -->
                                    <div class="input-group-append">
                                        <a href="{{route('v2.submission.vsuccess')}}" class="btn btn-primary" role="button" type="submit">
