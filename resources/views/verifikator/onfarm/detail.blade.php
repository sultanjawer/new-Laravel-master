        ...
        <div id="panel-2" class="panel">
            <div class="panel-hdr">
                ...
                <div class="panel-toolbar">
					...
					-->
                    <a href="{{route('verif.onfarm.add')}}" class="mr-1 btn btn-primary btn-xs btn-icon rounded-circle waves-effect waves-themed" data-toggle="tooltip" data-offset="0,10" data-original-title="Tambah Lokasi Sampling">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{route('verif.onfarm.show')}}"><i class="fal fa-edit"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td hidden>Kelompoktan</td>
                                ...
                                <tr>
                                    ...
                                    <td>API Vol</td>
                                    <td>API Vol</td>
                                    <td class="text-center"><a href="{{route('verif.onfarm.show')}}"><i class="fal fa-edit"></i></a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-md-6 my-1">
                            <a href="{{route('verif.onfarm')}}" class="btn btn-sm btn-primary btn-block waves-effect waves-themed" data-toggle="tooltip" data-offset="0,10" data-original-title="Simpan dan submit data"><i class="fas fa-save"></i> Simpan</a>
                        </div>
                        <div class="col-md-6 my-1">
                            <a href="{{route('verif.onfarm')}}" class="btn btn-sm btn-warning btn-block waves-effect waves-themed" data-toggle="tooltip" data-offset="0,10" data-original-title="Batalkan"><i class="fas fa-undo"></i> Batalkan</a>
                        </div>
                    </div>
                </div>
            </div>
