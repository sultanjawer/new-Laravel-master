    ...
    <div class="col-lg-12">
        ...
        <div id="panel-5" class="panel">
            ...
            <div class="panel-hdr">
                ...
                <div class="panel-toolbar">
                    <a href="{{route('verif.online.add')}}" class="mr-1 btn btn-primary btn-xs waves-effect waves-themed" data-toggle="tooltip" data-offset="0,10" data-original-title="Tambah Pemeriksaan Kelompoktani">
                        <i class="fal fa-map-marker-plus mr-1"></i>Add Location
                    </a>
                    @include('partials.globaltoolbar')
                </div>
            </div>
                        ...
                        <table id="dt-geoCheck" class="table table-sm table-bordered table-hover table-striped w-100">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{route('verif.online.show')}}"><i class="fal fa-edit"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td hidden>Kelompoktan</td>
                                    ...
                                    <td class="text-center">
                                        <a href="{{route('verif.online.detail')}}"><i class="fal fa-edit"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td hidden>Kelompoktan</td>
