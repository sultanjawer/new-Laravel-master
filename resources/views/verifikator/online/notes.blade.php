    ...
    <div class="col-12">
        <div class="mb-2">
            <ul class="nav nav-pills" role="tablist">
                <li class="nav-item"><a class="btn-sm nav-link active" data-toggle="pill" href="#activity"><i class="fas fa-edit mr-1"></i>Catatan Kegiatan</a></li>
                <li class="nav-item"><a class="btn-sm nav-link" data-toggle="pill" href="#constraint"><i class="fas fa-exclamation-triangle mr-1"></i>Catatan Kendala</a></li>
                <li class="nav-item"><a class="btn-sm nav-link" data-toggle="pill" href="#assists"><i class="fas fa-hands-helping mr-1"></i>Data Bantuan</a></li>
                <li class="nav-item"><a class="btn-sm nav-link" data-toggle="pill" href="#shields"><i class="fas fa-shield-alt mr-1"></i>Data Pengendalian</a></li>
                <li class="nav-item"><a class="btn-sm nav-link" data-toggle="pill" href="#bugs"><i class="fas fa-bug mr-1"></i>Data OPT</a></li>
                @if (\Auth::user()->type=='user')
                <li class="nav-item"><a class="btn-sm nav-link" href="/farm"><i class="fas fa-undo mr-1"></i>Kembali</a></li>
                @elseif (\Auth::user()->type=='verifikator')
                <li class="nav-item"><a class="btn-sm nav-link" href="{{route('verif.online.add')}}"><i class="fas fa-undo mr-1"></i>Kembali</a></li>
                @endif
            </ul>
        </div>
        <div class="alert alert-info border-0 mb-0">
            ...
            <span>Bagian ini dapat Anda gunakan untuk memverifikasi catatan kegiatan (usaha tani/tanam) mingguan, kendala, bantuan saprodi per lokasi lahan, catatan pengendalian, serta catatan serangan Organisme Pengganggu Tanaman.<span>
        </div>
                                        ...
                                        <td class="text-center">
                                            <div class="justify-content-between">
                                                ...
                                                <a class="mr-1" role="button" data-toggle="modal" data-target=".edit-act-modal-right">
                                                    ...
                                                    <i class="fas fa-ballot text-info" data-toggle="tooltip" data-offset="0,10" title data-original-title="show data"></i>
                                                </a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="justify-content-between">
                                                ...
                                                @elseif (\Auth::user()->type=='verifikator')
                                                <a class="mr-1" role="button" data-toggle="modal" data-target=".edit-const-example-modal-right">
                                                    <i class="fas fa-ballot text-info" data-toggle="tooltip" data-offset="0,10" title data-original-title="view this data"></i>
                                                </a>
                                                @endif
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="justify-content-between">
                                                ...
                                                @elseif (\Auth::user()->type=='verifikator')
                                                <a class="mr-1" role="button" data-toggle="modal" data-target=".edit-assists-example-modal-right">
                                                    <i class="fas fa-ballot text-info" data-toggle="tooltip" data-offset="0,10" title data-original-title="show this data"></i>
                                                </a>
                                                @endif
                                            </div>
                                        </td>
