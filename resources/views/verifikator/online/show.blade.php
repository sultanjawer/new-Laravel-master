    ...
    <div class="col-12">
        <div class="panel" id="panel-1">
            ...
            <div class="panel-container show">
                ...
                <hr>
                <div class="panel-content">
                    <a href="{{route('verif.online.show.notes')}}" class="btn btn-sm btn-info" role="button" type="submit"><i class="fa fa-farm"></i> Lihat Catatan Kegiatan</a>
                </div>
            </div>
        </div>
            ...
            <div class="panel-container show">
                ...
                <div class="panel-content py-2 rounded-bottom border-faded border-left-0 border-right-0 border-bottom-0 text-muted">
                    <div class="justify-content-end">
                        <a href="{{route('verif.online.detail')}}" class="btn btn-sm btn-info" role="button" type="submit"><i class="fa fa-save"></i> Simpan</a>
                        <a href="{{route('verif.online.detail')}}" class="btn btn-sm btn-warning" role="button" type="submit"><i class="fa fa-undo"></i> Batal</a>
                    </div>
                </div>
            </div>
        </div>
